        ...
        <Grid>
            <Paper style={paperStyle}>
                <Grid align='center'>
                    ...
                    <h2 style={headerStyle}><FormattedMessage id="app.signup"></FormattedMessage></h2>
                    <Typography variant='caption' gutterBottom><FormattedMessage id="app.signup.title"></FormattedMessage></Typography>
                </Grid>
                <Formik initialValues={initialValues} validationSchema={validationSchema} onSubmit={onSubmit}>
                    {(props) => (
                        <Form>
                            <Field as={TextField} fullWidth name="userName" label={
                                <FormattedMessage id="app.signup.fields.name"></FormattedMessage>}
                                placeholder="Enter your name" helperText={<ErrorMessage style={{ color: 'red' }} name="userName" />} />
                            ...
                            <Field as={TextField} fullWidth name="confirmPassword" type="password"
                                label={
                                    <FormattedMessage id="app.signup.fields.confirm_password"></FormattedMessage>} placeholder="Confirm your password"
                                helperText={<ErrorMessage name="confirmPassword" />} />
                            <FormControlLabel
                                control={<Field as={Checkbox} name="termsAndConditions" />}
                                label={<FormattedMessage id="app.signup.fields.terms"></FormattedMessage>}
                            />
                            <FormHelperText><ErrorMessage name="termsAndConditions" /></FormHelperText>
                            <Grid container spacing={5} ml={1}>
                                <Grid item xs={10} md={8} lg={4}>
                                    <Button type='submit' variant='contained' disabled={props.isSubmitting}
                                        color='primary'>{props.isSubmitting ? "Loading" : <FormattedMessage id="app.signup"></FormattedMessage>}</Button>
                                </Grid>
                                <Grid item xs={10} md={8} lg={4}>
